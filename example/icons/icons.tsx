...
export function GoogleAnalyticsIcon(): JSX.Element {
    return (
        <svg className="custom-icon google-analytics-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             width="192px" height="192px" viewBox="0 0 192 192" enableBackground="new 0 0 192 192" xmlSpace="preserve">
...
export function ActiveCampaignIcon(): JSX.Element {
    return (
        <svg className="custom-icon activecampaign-icon" version="1.1" baseProfile="basic" id="Layer_1"
             xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="288px"
             height="288px"
             viewBox="0 0 288 288" xmlSpace="preserve">
            <g>
                <path className="st0"
                      d="M146.6,150.7c2.6,0,5.2-1,8-3.1c3.3-2.3,6.2-4.2,6.2-4.2l1-0.7l-1-0.7c-0.4-0.3-43.9-30.5-48.4-33.4c-2.1-1.5-4.5-1.8-6.4-0.9c-1.8,0.9-2.8,2.8-2.8,5.1v10.3l0.4,0.2c0.3,0.2,30.2,21,36,24.9C142,149.9,144.3,150.7,146.6,150.7z"/>
                <path className="st0"
                      d="M204.9,132.6c-2.6-1.9-95.9-67-99.9-69.8l-1.3-0.9v16c0,5.1,2.7,7,6,9.4c0,0,71.6,49.9,80.5,56c-8.9,6.2-76.3,52.9-80.6,55.6c-5.1,3.4-5.6,5.6-5.6,10.2v17.2c0,0,98.7-70.6,100.8-72.2l0,0c4.5-3.4,5.5-7.4,5.6-10.3l0-1.8C210.5,138.4,208.6,135.2,204.9,132.6z"/>
            </g>
        </svg>
    );
}

export function WoocommerceIcon(): JSX.Element {
    return (
        <svg className="custom-icon woocommerce-icon" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 290 150">
...
export function ShopifyIcon(): JSX.Element {
